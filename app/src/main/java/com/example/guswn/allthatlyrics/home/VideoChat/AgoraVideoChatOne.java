package com.example.guswn.allthatlyrics.home.VideoChat;
...
public class AgoraVideoChatOne extends AppCompatActivity {


    private static final String LOG_TAG = AgoraVideoChatOne.class.getSimpleName();
