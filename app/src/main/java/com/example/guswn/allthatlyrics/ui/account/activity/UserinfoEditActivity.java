        ...
        call.enqueue(new Callback<userResponse3>() {
            ...
            public void onResponse(Call<userResponse3> call, Response<userResponse3> response) {
                ...
                if(!username.isEmpty()){
                    ...
                    INTRODUCE = introduce;
                    PHOTO = photo;
                    Log.e("getoneinfo_PHOTO",getString(R.string.URL)+PHOTO);
...
//                        edit_img.setImageBitmap(decodedByte);
                        Glide.with(UserinfoEditActivity.this)
...
//    }
    ...
    public void infoUpload(final Boolean isShot){
        ...
        String email = MyPreference.getMY_EMAIL(UserinfoEditActivity.this);
        map.put("Email",email);
        ...
        call.enqueue(new Callback<UserResponse2>() {
            ...
            public void onResponse(Call<UserResponse2> call, Response<UserResponse2> response) {
                ...
                if(value.equals("1")){
                    MyPreference.setUserName(UserinfoEditActivity.this,username,MY_EMAIL);
                    MyPreference.setUserPhoto(UserinfoEditActivity.this,photo,MY_EMAIL);
                    MyPreference.setUserBirthday(UserinfoEditActivity.this,birthday,MY_EMAIL);
                    MyPreference.setUserIntroduce(UserinfoEditActivity.this,introduce,MY_EMAIL);
                    MY_NAME = username;
                    MY_IMG = photo;
                   // Userinfo_Edit.this.finish();// 인텐트로 넘기지 못하는구나.. ㅠㅠ
                    ...
                    Toast.makeText(UserinfoEditActivity.this,message,Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<UserResponse2> call, Throwable t) {
                ...
                Toast.makeText(UserinfoEditActivity.this,"Error : "+t.getMessage(),Toast.LENGTH_SHORT).show();
    ...
    public void imgUpload(){
        ...
        progressDoalog = new ProgressDialog(UserinfoEditActivity.this);
...
//                        photo = BitMapToString(decodedByte);
    ...
    public void img_info_Upload(){
        ...
        Call<UserResponse2> call = api.uploadPhoto_Info(
                createPartFromString(MyPreference.getMY_EMAIL(UserinfoEditActivity.this)),
...
//                photo = BitMapToString(decodedByte);
    ...
    public void CameraPermission(){
        ...
        TedPermission.with(UserinfoEditActivity.this)
