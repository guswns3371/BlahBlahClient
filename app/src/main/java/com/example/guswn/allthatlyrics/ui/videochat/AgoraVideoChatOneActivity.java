package com.example.guswn.allthatlyrics.ui.videochat;
...
public class AgoraVideoChatOneActivity extends AppCompatActivity {


    private static final String LOG_TAG = AgoraVideoChatOneActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agora_video_chat_one_view);
    ...
    private void initializeAgoraEngine() {
        try {
            mRtcEngine = RtcEngine
                    .create(AgoraVideoChatOneActivity.this,
