package com.example.guswn.allthatlyrics.ui.social.reply;
...
public class SocialReplyActivity extends AppCompatActivity implements SocialReplyAdapter.SocialReplyClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myGlide.glideURL(getString(R.string.URL)+MY_IMG);
        ...
        SocialReplyModel Firstmodel = new SocialReplyModel("null",history_useridx,replyroom_idx,history_username,getString(R.string.URL)+history_userimg,history_content,history_time,"");
                ...
                for (SocialReplyResponse one : list){
                    ...
                    if (r_value.equals("1")){
                        if (r_roomdix.equals(replyroom_idx)){ // 들어온 댓글 방에 해당하는 정보로 추리기
                            ...
                            /**댓글 유저 정보*/
                            List<userResponse3> userinfoarray = one.getUserIdx_Info();
                            userResponse3 userinfo = userinfoarray.get(0);
                            ...
                            SocialReplyModel loadedmodel = new SocialReplyModel(r_idx,useridx,r_roomdix,username,
                                    getString(R.string.URL_withoutslash)+userimg,r_content,r_time,"답글 달기");
                            ...
                            for (SocialReReplyReponse rere : ReReply_info){
                                ...
                                if (!rere_idx.equals("null")){
                                    if (rere_roomidx.equals(replyroom_idx)){
                                        ...
                                        /**대댓글 유저 정보*/
                                        userResponse3 rere_userinfo = rere.getRere_UserIdx_Info();
                                        ...
                                        SocialReplyModel rere_loadedmodel =
                                                new SocialReplyModel(rere_idx,rere_useridx,rere_roomidx,rere_username,
                                                        getString(R.string.URL_withoutslash)+rere_userimg,rere_content,rere_time,"답글 달기");
                ...
                public void run() {
                    ...
                    if (reply_roomidx.equals(replyroom_idx)){
                        if (reply_content!=null){
                            ...
                            SocialReplyModel model = new SocialReplyModel(idx,reply_useridx,reply_roomidx,reply_username,getString(R.string.URL)+reply_userimg,reply_content,reply_time,"답글 달기");
