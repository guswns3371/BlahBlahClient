...
public class FollowTab extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    FollowerTabFragment _followerTabFragment = new FollowerTabFragment();
                    return _followerTabFragment;
                case 1:
                    FollowingTabFragment _followingTabFragment = new FollowingTabFragment();
                    return _followingTabFragment;
