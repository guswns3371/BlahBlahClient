...
//                    infoUpload();
    ...
    public void getoneinfo(){
        ...
        Call<UserResponse_3> call = api.getOneInfo(MY_EMAIL);
...
//    }
    ...
    public void infoUpload(final Boolean isShot){
        ...
        Call<UserResponse_2> call = api.editUserInfo(map);

        call.enqueue(new Callback<UserResponse_2>() {
            @Override
            public void onResponse(Call<UserResponse_2> call, Response<UserResponse_2> response) {
                if(!response.isSuccessful()){
                ...
                UserResponse_2 val = response.body();
            ...
            @Override
            public void onFailure(Call<UserResponse_2> call, Throwable t) {
...
//                        photo = BitMapToString(decodedByte);
    ...
    public void img_info_Upload(){
        ...
        Call<UserResponse_2> call = api.uploadPhoto_Info(
